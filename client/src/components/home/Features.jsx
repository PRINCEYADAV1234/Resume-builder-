...
export default function Features() {
  ...
  const [isHover, setIsHover] = React.useState(false);
    ...
    return (
        <>
                <div id="features" className="text-center mt-20">
                    {/* <h1 className="text-4xl">Built Your Resume</h1> */}
                    <h2 className="text-3xl sm:text-4xl font-medium">Build your resume</h2>
                    <p className="mt-4 text-gray-500">
                        Our streamlined process helps you create a professional resume in minutes with <br /> intelligent AI-powered tools and features.
                    </p>
                </div>
