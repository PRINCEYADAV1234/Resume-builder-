export default function Testimonials(){
    ...
    return (
        ...
        `}</style>
          ...
          <div id="testimonials" className="text-center mt-20">
                    {/* <h1 className="text-4xl">Built Your Resume</h1> */}
                    <h2 className="text-3xl sm:text-4xl font-medium">Don't just take our words</h2>
                    <p className="mt-4 text-gray-500">
                    Hear what our users say about us. We're always looking for ways to improve. If you <br /> have a positive experience with us, leave a review
                    </p>
                </div>
